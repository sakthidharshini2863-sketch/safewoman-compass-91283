...
const transportData: Record<string, TransportService[]> = {
  ...
  'london': [
    { name: 'Uber', type: 'Ride-sharing', phone:'08081897190',description: 'Global ride-sharing service with safety features', available: true },
    { name: 'Bolt', type: 'Ride-sharing', phone:'8081698818',description: 'European ride-sharing service', available: true },
    { name: 'Black Cabs', type: 'Licensed Taxi', phone:'2034332170',description: 'Traditional London black cabs', available: true },
    { name: 'Gett', type: 'Taxi App', phone:'2073974300',description: 'Licensed taxi booking service', available: true },
  ],
  'delhi': [
    { name: 'Uber', type: 'Ride-sharing',phone:'0800468237', description: 'Global ride-sharing service with safety features', available: true },
    { name: 'Ola', type: 'Ride-sharing', phone:'8067340900',description: 'Indian ride-sharing with SOS button', available: true },
    { name: 'Pink Cabs Delhi', type: 'Women-Only', phone: '011-4567-8900', description: 'Women-only cab service', available: true },
    { name: 'Meru Cabs', type: 'Radio Taxi', phone: '44224422', description: 'Trusted radio taxi service', available: true },
  ],
  'bengaluru': [
    { name: 'Uber', type: 'Ride-sharing', phone:'884724422',description: 'Global ride-sharing service', available: true },
    { name: 'Ola', type: 'Ride-sharing', phone:'8067350900', description: 'Indian ride-sharing with SOS', available: true },
    { name: 'Women Cab Bangalore', type: 'Women-Only', phone: '080-1234-5678', description: 'Women-driven cabs', available: true },
  ],
  'paris': [
    { name: 'Uber', type: 'Ride-sharing',phone:'0800468237', description: 'Global ride-sharing service', available: true },
    { name: 'Bolt', type: 'Ride-sharing',phone:'8081698818', description: 'European ride-sharing', available: true },
