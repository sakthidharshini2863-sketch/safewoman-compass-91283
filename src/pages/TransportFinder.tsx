...
const transportData: Record<string, TransportService[]> = {
  'new york': [
    ...
    { name: 'Curb', type: 'Taxi App', phone:'(718)222-0600' description: 'Official NYC taxi app', available: true },
  ],
  'mumbai': [
    { name: 'Uber', type: 'Ride-sharing',phone:'8046852999' description: 'Global ride-sharing service with safety features', available: true },
    { name: 'Ola', type: 'Ride-sharing', phone:'8067350900'description: 'Indian ride-sharing with SOS button', available: true },
  ...
  'delhi': [
    { name: 'Uber', type: 'Ride-sharing', phone:''description: 'Global ride-sharing service with safety features', available: true },
    { name: 'Ola', type: 'Ride-sharing', phone:''description: 'Indian ride-sharing with SOS button', available: true },
