...
const cityData: Record<string, any> = {
  'new york': {
    helplines: [
      ...
      { name: 'Embassy helpline',number:'+1 202-501-4444',type:'USA'},
  ...
  'mumbai': {
    helplines: [
      ...
      { name: 'Embassy helpline',number:'+91 11 2301 4101',type:'INDIA'},
    ],
    safetyScore: 65,
    crimeRate: 'Moderate',
    trend: 'down',
  ...
  'london': {
    helplines: [
      ...
      { name: 'Embassy helpline',number:'+44 20 7008 5000',type:'UK'},
    ],
    safetyScore: 78,
    crimeRate: 'Low',
    trend: 'down',
  ...
  'hyderabad': {
    ...
    helplines: [
      ...
      { name: 'Embassy helpline',number:'2267866014',type:'FRANCE'},
    ],
    safetyScore: 59,
    crimeRate: 'Moderate',
    trend: 'improving',
  ...
  'tokyo': {
    helplines: [
      ...
      { name: 'Embassy helpline',number:'0335803311',type:'JAPAN'},
    ],
    safetyScore: 86,
    crimeRate: 'Low',
    trend: 'improving',
  ...
  'sydney': {
    helplines: [
      ...
      { name: 'Embassy helpline',number:'262613305',type:'AUSTRALIA'},
    ],
    safetyScore: 48,
    crimeRate: 'High',
    trend: 'improving',
  ...
  'toronto': {
    helplines: [
      ...
      { name: 'Embassy helpline',number:'1800111363',type:'CANADA'},
    ],
    safetyScore: 50,
    crimeRate: 'Moderate',
    trend: 'improving',
  ...
  helplines: [
    ...
    { name: 'Embassy helpline',number:'2222043205',type:'SOUTH ASIA'},
    ],
    safetyScore: 89,
    crimeRate: 'Low',
    trend: 'improving',
...
'moscow': {
  helplines: [
    ...
    { name: 'Embassy helpline',number:'9652773414',type:'RUSSIA'},
    ],
    safetyScore: 68,
    crimeRate: 'Moderate',
    trend: 'improving',
